...
class S3(S3Interface):
    def __init__(
        self, aws_access_key_id: str, aws_secret_access_key: str, aws_region: str, logging: bool = False
    ):
        """
        AWS S3 client.
        ...
        Args:
            ...
            logging: If True, the client will show logs.

        Raises:
            Exception: If the credentials or region are not well defined.
        """
        self.__client = S3WithLogs(
            aws_access_key_id=aws_access_key_id,
            aws_secret_access_key=aws_secret_access_key,
            aws_region=aws_region,
        ) if logging else S3WithoutLogs(
            aws_access_key_id=aws_access_key_id,
            aws_secret_access_key=aws_secret_access_key,
            aws_region=aws_region,
        )
